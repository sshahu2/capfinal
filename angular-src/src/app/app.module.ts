...
import { AssessComponent } from './homescreen/assess/assess.component';
//again
...
const appRoutes:Routes =[
  {path:'',component:HomeComponent},
   {path:'register',component:RegisterComponent},
    ...
    //added
   { path: 'assess/:id/:id_id/:id_id_id',component: TestComponent,canActivate:[AuthGuard]},
  { path: 'assess/:id/:id_id',component: SubdomComponent,canActivate:[AuthGuard]},
  { path: 'analysis/:id',component: ChartComponent,canActivate:[AuthGuard]},
  { path: 'assess/:id', component: TestpageComponent,canActivate:[AuthGuard] },
